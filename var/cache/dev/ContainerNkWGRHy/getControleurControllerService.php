 ...
 */
class getControleurControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\ControleurController' shared autowired service.
     *
     * @return \App\Controller\ControleurController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'AbstractController.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'ControleurController.php';

        $container->services['App\\Controller\\ControleurController'] = $instance = new \App\Controller\ControleurController();
        ...
        ]))->withContext('App\\Controller\\ControleurController', $container));
